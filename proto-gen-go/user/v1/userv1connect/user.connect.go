...
type UserServiceClient interface {
	...
	// Create new User
	CreateUser(context.Context, *connect_go.Request[v1.CreateUserRequest]) (*connect_go.Response[v1.CommonUUIDRequest], error)
	// Update User by ID
	UpdateUser(context.Context, *connect_go.Request[v1.UpdateUserRequest]) (*connect_go.Response[v1.CommonUUIDRequest], error)
	// Delete User
	DeleteUser(context.Context, *connect_go.Request[v1.CommonUUIDRequest]) (*connect_go.Response[v1.CommonUUIDRequest], error)
}
...
func NewUserServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) UserServiceClient {
	...
	return &userServiceClient{
		...
		createUser: connect_go.NewClient[v1.CreateUserRequest, v1.CommonUUIDRequest](
			httpClient,
			baseURL+"/user.v1.UserService/CreateUser",
			opts...,
		),
		updateUser: connect_go.NewClient[v1.UpdateUserRequest, v1.CommonUUIDRequest](
			httpClient,
			baseURL+"/user.v1.UserService/UpdateUser",
			opts...,
		),
		deleteUser: connect_go.NewClient[v1.CommonUUIDRequest, v1.CommonUUIDRequest](
			httpClient,
...
type userServiceClient struct {
	...
	createUser   *connect_go.Client[v1.CreateUserRequest, v1.CommonUUIDRequest]
	updateUser   *connect_go.Client[v1.UpdateUserRequest, v1.CommonUUIDRequest]
	deleteUser   *connect_go.Client[v1.CommonUUIDRequest, v1.CommonUUIDRequest]
}
...
func (c *userServiceClient) CreateUser(ctx context.Context, req *connect_go.Request[v1.CreateUserRequest]) (*connect_go.Response[v1.CommonUUIDRequest], error) {
	return c.createUser.CallUnary(ctx, req)
}

// UpdateUser calls user.v1.UserService.UpdateUser.
func (c *userServiceClient) UpdateUser(ctx context.Context, req *connect_go.Request[v1.UpdateUserRequest]) (*connect_go.Response[v1.CommonUUIDRequest], error) {
	return c.updateUser.CallUnary(ctx, req)
}

// DeleteUser calls user.v1.UserService.DeleteUser.
func (c *userServiceClient) DeleteUser(ctx context.Context, req *connect_go.Request[v1.CommonUUIDRequest]) (*connect_go.Response[v1.CommonUUIDRequest], error) {
...
func (UnimplementedUserServiceHandler) CreateUser(context.Context, *connect_go.Request[v1.CreateUserRequest]) (*connect_go.Response[v1.CommonUUIDRequest], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("user.v1.UserService.CreateUser is not implemented"))
}

func (UnimplementedUserServiceHandler) UpdateUser(context.Context, *connect_go.Request[v1.UpdateUserRequest]) (*connect_go.Response[v1.CommonUUIDRequest], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("user.v1.UserService.UpdateUser is not implemented"))
}

func (UnimplementedUserServiceHandler) DeleteUser(context.Context, *connect_go.Request[v1.CommonUUIDRequest]) (*connect_go.Response[v1.CommonUUIDRequest], error) {
